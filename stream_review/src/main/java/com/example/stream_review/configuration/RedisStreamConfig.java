...
public class RedisStreamConfig {
    ...
    @Value("${redis.app_channel:channel_message}")
    String topic;

    @Value("${redis.app_stream:stream_data}")
    String streamKey;
    ...
    @Autowired
    @Lazy
    public StreamListener<String, ObjectRecord<String, GamePayment>> paymentListener;
